L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:100px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:100px; margin-top:10px;background-color:#FFFFFF"></div></div>');
